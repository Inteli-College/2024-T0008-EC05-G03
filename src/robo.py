...
# Faz com que o robô pegue o remédio 2 e coloque no destino 2. #Remedio 2 ta rente
spinner.start()
robo.move_to_J(remedio2[0], remedio2[1], 55.64, remedio2[3], wait=True)
robo.move_to(remedio2[0], remedio2[1], -9.34, remedio2[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
...
# Faz com que o robô pegue o remédio 3 e coloque no destino 3. 3 ta descentralizado
spinner.start()
robo.move_to_J(remedio3[0], remedio3[1], 55.64, remedio3[3], wait=True)
robo.move_to(remedio3[0], remedio3[1], -9.34, remedio3[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
...
# Faz com que o robô pegue o remédio 4 e coloque no destino 4. 4 ta descentralizado e rente
spinner.start()
robo.move_to_J(remedio4[0], remedio4[1], 55.64, remedio4[3], wait=True)
robo.move_to(remedio4[0], remedio4[1], -9.34, remedio4[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
...
robo.move_to(remedio5[0], remedio5[1], -9.34, remedio5[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
...
robo.move_to(remedio6[0], remedio6[1], -9.34, remedio6[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
...
robo.move_to(remedio7[0], remedio7[1], -9.34, remedio7[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
...
robo.move_to(remedio8[0], remedio8[1], -9.34, remedio8[3], wait=True)
robo.suck(True)
robo.wait(200)
robo.move_to_J(home[0], home[1], home[2], home[3], wait=True)
